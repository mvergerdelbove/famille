...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PrestatairePlanning.start_date'
        db.alter_column(u'famille_prestataireplanning', 'start_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'FamillePlanning.start_date'
        db.alter_column(u'famille_familleplanning', 'start_date', self.gf('django.db.models.fields.DateTimeField')())
