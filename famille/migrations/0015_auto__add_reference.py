...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'famille_reference', (
            ...
            ('prestataire', self.gf('django.db.models.fields.related.ForeignKey')(related_name='references', to=orm['famille.Prestataire'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True)),
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True)),
            ('missions', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('referenced_user', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='reference_of', unique=True, null=True, to=orm['famille.Famille'])),
        ))
        db.send_create_signal(u'famille', ['Reference'])


    def backwards(self, orm):
        # Deleting model 'Reference'
        db.delete_table(u'famille_reference')
    ...
    models = {
        ...
        u'famille.reference': {
            ...
            'prestataire': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'references'", 'to': u"orm['famille.Prestataire']"}),
            'referenced_user': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'reference_of'", 'unique': 'True', 'null': 'True', 'to': u"orm['famille.Famille']"}),
            'updated_at': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'})
        }
    }
