...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Famille.pseudo'
        db.add_column(u'famille_famille', 'pseudo',
                      self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Famille.pseudo'
        db.delete_column(u'famille_famille', 'pseudo')
    ...
    models = {
        ...
        'famille.famille': {
            ...
            'pseudo': ('django.db.models.fields.CharField', [], {'max_length': '60', 'null': 'True', 'blank': 'True'}),
