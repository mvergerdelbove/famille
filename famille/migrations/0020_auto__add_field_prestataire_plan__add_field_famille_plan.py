...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Prestataire.plan'
        db.add_column(u'famille_prestataire', 'plan',
                      self.gf('django.db.models.fields.CharField')(default='basic', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'Famille.plan'
        db.add_column(u'famille_famille', 'plan',
                      self.gf('django.db.models.fields.CharField')(default='basic', max_length=20, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Prestataire.plan'
        db.delete_column(u'famille_prestataire', 'plan')

        # Deleting field 'Famille.plan'
        db.delete_column(u'famille_famille', 'plan')
