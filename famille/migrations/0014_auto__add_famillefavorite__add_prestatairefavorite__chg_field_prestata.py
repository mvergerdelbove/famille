...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FamilleFavorite'
        db.create_table(u'famille_famillefavorite', (
            ...
            ('famille', self.gf('django.db.models.fields.related.ForeignKey')(related_name='favorites', to=orm['famille.Famille'])),
        ))
        db.send_create_signal(u'famille', ['FamilleFavorite'])

        # Adding model 'PrestataireFavorite'
        db.create_table(u'famille_prestatairefavorite', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
            ('object_id', self.gf('django.db.models.fields.IntegerField')()),
            ('object_type', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('prestataire', self.gf('django.db.models.fields.related.ForeignKey')(related_name='favorites', to=orm['famille.Prestataire'])),
        ))
        db.send_create_signal(u'famille', ['PrestataireFavorite'])


        # Changing field 'Prestataire.resume'
        db.alter_column(u'famille_prestataire', 'resume', self.gf('famille.utils.fields.ContentTypeRestrictedFileField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting model 'FamilleFavorite'
        db.delete_table(u'famille_famillefavorite')

        # Deleting model 'PrestataireFavorite'
        db.delete_table(u'famille_prestatairefavorite')


        # Changing field 'Prestataire.resume'
        db.alter_column(u'famille_prestataire', 'resume', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
    ...
    models = {
        ...
        u'famille.famillefavorite': {
            'Meta': {'object_name': 'FamilleFavorite'},
            'created_at': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'famille': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'favorites'", 'to': u"orm['famille.Famille']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'famille.prestatairefavorite': {
            'Meta': {'object_name': 'PrestataireFavorite'},
            'created_at': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_id': ('django.db.models.fields.IntegerField', [], {}),
            'object_type': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'prestataire': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'favorites'", 'to': u"orm['famille.Prestataire']"}),
            'updated_at': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'})
        },
