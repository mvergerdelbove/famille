...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Enfant.e_school'
        db.alter_column(u'famille_enfant', 'school', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, db_column='school'))

    def backwards(self, orm):

        # Changing field 'Enfant.e_school'
        db.alter_column(u'famille_enfant', 'school', self.gf('django.db.models.fields.DateField')(null=True, db_column='school'))
