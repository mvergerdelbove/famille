...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Prestataire.ipn'
        db.add_column(u'famille_prestataire', 'ipn',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ipn.PayPalIPN'], unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Famille.ipn'
        db.add_column(u'famille_famille', 'ipn',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ipn.PayPalIPN'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Prestataire.ipn'
        db.delete_column(u'famille_prestataire', 'ipn_id')

        # Deleting field 'Famille.ipn'
        db.delete_column(u'famille_famille', 'ipn_id')
