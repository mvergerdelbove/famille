...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Prestataire.type_garde'
        db.add_column(u'famille_prestataire', 'type_garde',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Prestataire.tarif'
        db.add_column(u'famille_prestataire', 'tarif',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Prestataire.description'
        db.add_column(u'famille_prestataire', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Prestataire.type_garde'
        db.delete_column(u'famille_prestataire', 'type_garde')

        # Deleting field 'Prestataire.tarif'
        db.delete_column(u'famille_prestataire', 'tarif')

        # Deleting field 'Prestataire.description'
        db.delete_column(u'famille_prestataire', 'description')
