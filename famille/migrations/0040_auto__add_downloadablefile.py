...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DownloadableFile'
        db.create_table(u'famille_downloadablefile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('file_content', self.gf('famille.utils.fields.ContentTypeRestrictedFileField')(max_length=100)),
            ('file_type', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal('famille', ['DownloadableFile'])


    def backwards(self, orm):
        # Deleting model 'DownloadableFile'
        db.delete_table(u'famille_downloadablefile')
