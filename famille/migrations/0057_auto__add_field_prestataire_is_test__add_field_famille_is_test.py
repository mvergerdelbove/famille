...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Prestataire.is_test'
        db.add_column(u'famille_prestataire', 'is_test',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Famille.is_test'
        db.add_column(u'famille_famille', 'is_test',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Prestataire.is_test'
        db.delete_column(u'famille_prestataire', 'is_test')

        # Deleting field 'Famille.is_test'
        db.delete_column(u'famille_famille', 'is_test')
