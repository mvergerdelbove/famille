...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Prestataire.pseudo'
        db.add_column(u'famille_prestataire', 'pseudo',
                      self.gf('django.db.models.fields.CharField')(max_length=60, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Prestataire.pseudo'
        db.delete_column(u'famille_prestataire', 'pseudo')
