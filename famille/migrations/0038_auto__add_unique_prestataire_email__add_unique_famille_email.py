...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Prestataire', fields ['email']
        db.create_unique(u'famille_prestataire', ['email'])

        # Adding unique constraint on 'Famille', fields ['email']
        db.create_unique(u'famille_famille', ['email'])


    def backwards(self, orm):
        # Removing unique constraint on 'Famille', fields ['email']
        db.delete_unique(u'famille_famille', ['email'])

        # Removing unique constraint on 'Prestataire', fields ['email']
        db.delete_unique(u'famille_prestataire', ['email'])
