...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Prestataire.profile_pic'
        db.add_column(u'famille_prestataire', 'profile_pic',
                      self.gf('famille.utils.fields.ContentTypeRestrictedFileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Famille.profile_pic'
        db.add_column(u'famille_famille', 'profile_pic',
                      self.gf('famille.utils.fields.ContentTypeRestrictedFileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Prestataire.profile_pic'
        db.delete_column(u'famille_prestataire', 'profile_pic')

        # Deleting field 'Famille.profile_pic'
        db.delete_column(u'famille_famille', 'profile_pic')
