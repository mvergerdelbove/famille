...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Famille', fields ['pseudo']
        db.create_unique(u'famille_famille', ['pseudo'])


    def backwards(self, orm):
        # Removing unique constraint on 'Famille', fields ['pseudo']
        db.delete_unique(u'famille_famille', ['pseudo'])
