...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'famille_famille', (
            ...
            ('updated_at', self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now)),
            ...
            ('country', self.gf('django.db.models.fields.CharField')(default='France', max_length=20)),
        ))
        db.send_create_signal(u'famille', ['Famille'])

        # Adding model 'Enfant'
        db.create_table(u'famille_enfant', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now)),
            ('updated_at', self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now)),
            ('famille', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['famille.Famille'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('age', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ))
        db.send_create_signal(u'famille', ['Enfant'])

        # Adding model 'Prestataire'
        db.create_table(u'famille_prestataire', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now)),
            ('updated_at', self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ...
            ('sub_types', self.gf('django.db.models.fields.CharField')(max_length=40)),
        ))
        db.send_create_signal(u'famille', ['Prestataire'])


    def backwards(self, orm):
        # Deleting model 'Famille'
        db.delete_table(u'famille_famille')

        # Deleting model 'Enfant'
        db.delete_table(u'famille_enfant')

        # Deleting model 'Prestataire'
        db.delete_table(u'famille_prestataire')
    ...
    models = {
        ...
        u'famille.enfant': {
            ...
            'famille': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['famille.Famille']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'updated_at': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime.now'})
        },
        u'famille.famille': {
            'Meta': {'object_name': 'Famille'},
            'city': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'country': ('django.db.models.fields.CharField', [], {'default': "'France'", 'max_length': '20'}),
            'created_at': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime.now'}),
