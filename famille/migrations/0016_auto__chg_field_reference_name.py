...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'famille_reference', 'name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Reference.name'
        db.alter_column(u'famille_reference', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))
