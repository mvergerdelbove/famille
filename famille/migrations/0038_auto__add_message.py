...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'famille_message', (
        ...
        db.send_create_signal('famille', ['Message'])

        # Adding M2M table for field recipients on 'Message'
        m2m_table_name = db.shorten_name(u'famille_message_recipients')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('message', models.ForeignKey(orm['famille.message'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'famille_message')

        # Removing M2M table for field recipients on 'Message'
        db.delete_table(db.shorten_name(u'famille_message_recipients'))
    ...
    models = {
        ...
        'famille.message': {
            ...
            'created_at': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recipients': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'received_messaged'", 'symmetrical': 'False', 'to': u"orm['auth.User']"}),
