...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DownloadableFile.index'
        db.add_column(u'famille_downloadablefile', 'index',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DownloadableFile.index'
        db.delete_column(u'famille_downloadablefile', 'index')
