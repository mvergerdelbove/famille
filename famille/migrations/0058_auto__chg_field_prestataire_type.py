...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Prestataire.type'
        db.alter_column(u'famille_prestataire', 'type', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

    def backwards(self, orm):

        # Changing field 'Prestataire.type'
        db.alter_column(u'famille_prestataire', 'type', self.gf('django.db.models.fields.CharField')(default=None, max_length=40))
