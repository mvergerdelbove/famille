...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FamilleRatings.serious'
        db.delete_column(u'famille_familleratings', 'serious')

        # Deleting field 'FamilleRatings.amability'
        db.delete_column(u'famille_familleratings', 'amability')

        # Deleting field 'FamilleRatings.ponctuality'
        db.delete_column(u'famille_familleratings', 'ponctuality')

        # Deleting field 'FamilleRatings.reliability'
        db.delete_column(u'famille_familleratings', 'reliability')

        # Adding field 'FamilleRatings.a'
        db.add_column(u'famille_familleratings', 'a',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'FamilleRatings.b'
        db.add_column(u'famille_familleratings', 'b',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'FamilleRatings.c'
        db.add_column(u'famille_familleratings', 'c',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'FamilleRatings.d'
        db.add_column(u'famille_familleratings', 'd',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Deleting field 'PrestataireRatings.serious'
        db.delete_column(u'famille_prestataireratings', 'serious')

        # Deleting field 'PrestataireRatings.amability'
        db.delete_column(u'famille_prestataireratings', 'amability')

        # Deleting field 'PrestataireRatings.ponctuality'
        db.delete_column(u'famille_prestataireratings', 'ponctuality')

        # Deleting field 'PrestataireRatings.reliability'
        db.delete_column(u'famille_prestataireratings', 'reliability')

        # Adding field 'PrestataireRatings.a'
        db.add_column(u'famille_prestataireratings', 'a',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'PrestataireRatings.b'
        db.add_column(u'famille_prestataireratings', 'b',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'PrestataireRatings.c'
        db.add_column(u'famille_prestataireratings', 'c',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'PrestataireRatings.d'
        db.add_column(u'famille_prestataireratings', 'd',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'FamilleRatings.serious'
        db.add_column(u'famille_familleratings', 'serious',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'FamilleRatings.amability'
        db.add_column(u'famille_familleratings', 'amability',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'FamilleRatings.ponctuality'
        db.add_column(u'famille_familleratings', 'ponctuality',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'FamilleRatings.reliability'
        db.add_column(u'famille_familleratings', 'reliability',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Deleting field 'FamilleRatings.a'
        db.delete_column(u'famille_familleratings', 'a')

        # Deleting field 'FamilleRatings.b'
        db.delete_column(u'famille_familleratings', 'b')

        # Deleting field 'FamilleRatings.c'
        db.delete_column(u'famille_familleratings', 'c')

        # Deleting field 'FamilleRatings.d'
        db.delete_column(u'famille_familleratings', 'd')

        # Adding field 'PrestataireRatings.serious'
        db.add_column(u'famille_prestataireratings', 'serious',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'PrestataireRatings.amability'
        db.add_column(u'famille_prestataireratings', 'amability',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'PrestataireRatings.ponctuality'
        db.add_column(u'famille_prestataireratings', 'ponctuality',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'PrestataireRatings.reliability'
        db.add_column(u'famille_prestataireratings', 'reliability',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Deleting field 'PrestataireRatings.a'
        db.delete_column(u'famille_prestataireratings', 'a')

        # Deleting field 'PrestataireRatings.b'
        db.delete_column(u'famille_prestataireratings', 'b')

        # Deleting field 'PrestataireRatings.c'
        db.delete_column(u'famille_prestataireratings', 'c')

        # Deleting field 'PrestataireRatings.d'
        db.delete_column(u'famille_prestataireratings', 'd')
    ...
    models = {
        ...
        'famille.familleratings': {
            ...
            'c': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
