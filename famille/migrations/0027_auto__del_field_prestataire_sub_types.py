...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Prestataire.sub_types'
        db.delete_column(u'famille_prestataire', 'sub_types')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Prestataire.sub_types'
        raise RuntimeError("Cannot reverse this migration. 'Prestataire.sub_types' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Prestataire.sub_types'
        db.add_column(u'famille_prestataire', 'sub_types',
