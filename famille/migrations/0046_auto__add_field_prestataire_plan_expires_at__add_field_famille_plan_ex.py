...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Prestataire.plan_expires_at'
        db.add_column(u'famille_prestataire', 'plan_expires_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Famille.plan_expires_at'
        db.add_column(u'famille_famille', 'plan_expires_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Prestataire.plan_expires_at'
        db.delete_column(u'famille_prestataire', 'plan_expires_at')

        # Deleting field 'Famille.plan_expires_at'
        db.delete_column(u'famille_famille', 'plan_expires_at')
