...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Geolocation.has_error'
        db.add_column(u'famille_geolocation', 'has_error',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Geolocation.lat'
        db.alter_column(u'famille_geolocation', 'lat', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Geolocation.lon'
        db.alter_column(u'famille_geolocation', 'lon', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Geolocation.has_error'
        db.delete_column(u'famille_geolocation', 'has_error')


        # User chose to not deal with backwards NULL issues for 'Geolocation.lat'
        raise RuntimeError("Cannot reverse this migration. 'Geolocation.lat' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Geolocation.lat'
        db.alter_column(u'famille_geolocation', 'lat', self.gf('django.db.models.fields.FloatField')())

        # User chose to not deal with backwards NULL issues for 'Geolocation.lon'
        raise RuntimeError("Cannot reverse this migration. 'Geolocation.lon' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Geolocation.lon'
        db.alter_column(u'famille_geolocation', 'lon', self.gf('django.db.models.fields.FloatField')())
