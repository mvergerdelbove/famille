...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PrestatairePlanning'
        db.create_table(u'famille_prestataireplanning', (
            ...
            ('frequency', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('prestataire', self.gf('django.db.models.fields.related.ForeignKey')(related_name='planning', to=orm['famille.Prestataire'])),
        ))
        db.send_create_signal(u'famille', ['PrestatairePlanning'])

        # Adding model 'FamillePlanning'
        db.create_table(u'famille_familleplanning', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
            ('start_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('frequency', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('famille', self.gf('django.db.models.fields.related.ForeignKey')(related_name='planning', to=orm['famille.Famille'])),
        ))
        db.send_create_signal(u'famille', ['FamillePlanning'])


    def backwards(self, orm):
        # Deleting model 'PrestatairePlanning'
        db.delete_table(u'famille_prestataireplanning')

        # Deleting model 'FamillePlanning'
        db.delete_table(u'famille_familleplanning')
