...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'famille_prestataire', 'pseudo',
                      self.gf('django.db.models.fields.CharField')(unique=True, max_length=60, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'famille.famille': {
            ...
            'tarif': ('django.db.models.fields.FloatField', [], {'default': '3.0', 'null': 'True', 'blank': 'True'}),
