...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Famille.visibility_family'
        db.add_column(u'famille_famille', 'visibility_family',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Famille.visibility_prestataire'
        db.add_column(u'famille_famille', 'visibility_prestataire',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Famille.visibility_logged'
        db.add_column(u'famille_famille', 'visibility_logged',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Famille.visibility_global'
        db.add_column(u'famille_famille', 'visibility_global',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Famille.visibility_family'
        db.delete_column(u'famille_famille', 'visibility_family')

        # Deleting field 'Famille.visibility_prestataire'
        db.delete_column(u'famille_famille', 'visibility_prestataire')

        # Deleting field 'Famille.visibility_logged'
        db.delete_column(u'famille_famille', 'visibility_logged')

        # Deleting field 'Famille.visibility_global'
        db.delete_column(u'famille_famille', 'visibility_global')
    ...
    models = {
        ...
        'famille.famille': {
            ...
            'visibility_family': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'visibility_global': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'visibility_logged': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'visibility_prestataire': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
