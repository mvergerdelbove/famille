...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reference.date_from'
        db.add_column(u'famille_reference', 'date_from',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Reference.date_to'
        db.add_column(u'famille_reference', 'date_to',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Reference.current'
        db.add_column(u'famille_reference', 'current',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reference.date_from'
        db.delete_column(u'famille_reference', 'date_from')

        # Deleting field 'Reference.date_to'
        db.delete_column(u'famille_reference', 'date_to')

        # Deleting field 'Reference.current'
        db.delete_column(u'famille_reference', 'current')
