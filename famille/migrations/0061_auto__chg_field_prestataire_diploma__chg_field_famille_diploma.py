...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Prestataire.diploma'
        db.alter_column(u'famille_prestataire', 'diploma', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=50, null=True))

        # Changing field 'Famille.diploma'
        db.alter_column(u'famille_famille', 'diploma', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Prestataire.diploma'
        db.alter_column(u'famille_prestataire', 'diploma', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
