...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Prestataire.type_garde'
        db.alter_column(u'famille_prestataire', 'type_garde', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=50, null=True))

        # Changing field 'Famille.type_garde'
        db.alter_column(u'famille_famille', 'type_garde', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Prestataire.type_garde'
        db.alter_column(u'famille_prestataire', 'type_garde', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Famille.type_garde'
        db.alter_column(u'famille_famille', 'type_garde', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
