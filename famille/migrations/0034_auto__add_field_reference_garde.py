...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reference.garde'
        db.add_column(u'famille_reference', 'garde',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reference.garde'
        db.delete_column(u'famille_reference', 'garde')
    ...
    models = {
        ...
        'famille.reference': {
            ...
            'garde': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
