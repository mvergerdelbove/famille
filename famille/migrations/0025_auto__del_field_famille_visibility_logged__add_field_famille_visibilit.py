...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Famille.visibility_not_logged'
        db.add_column(u'famille_famille', 'visibility_not_logged',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Famille.visibility_not_logged'
        db.delete_column(u'famille_famille', 'visibility_not_logged')
    ...
    models = {
        ...
        'famille.famille': {
            ...
            'visibility_not_logged': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
