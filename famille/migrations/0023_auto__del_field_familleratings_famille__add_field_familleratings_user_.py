...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FamilleRatings.famille'
        db.delete_column(u'famille_familleratings', 'famille_id')

        # Adding field 'FamilleRatings.user'
        db.add_column(u'famille_familleratings', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='ratings', to=orm['famille.Famille']),
                      keep_default=False)

        # Deleting field 'PrestataireRatings.prestataire'
        db.delete_column(u'famille_prestataireratings', 'prestataire_id')

        # Adding field 'PrestataireRatings.user'
        db.add_column(u'famille_prestataireratings', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='ratings', to=orm['famille.Prestataire']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'FamilleRatings.famille'
        raise RuntimeError("Cannot reverse this migration. 'FamilleRatings.famille' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'FamilleRatings.famille'
        db.add_column(u'famille_familleratings', 'famille',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='ratings', to=orm['famille.Famille']),
                      keep_default=False)

        # Deleting field 'FamilleRatings.user'
        db.delete_column(u'famille_familleratings', 'user_id')


        # User chose to not deal with backwards NULL issues for 'PrestataireRatings.prestataire'
        raise RuntimeError("Cannot reverse this migration. 'PrestataireRatings.prestataire' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'PrestataireRatings.prestataire'
        db.add_column(u'famille_prestataireratings', 'prestataire',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='ratings', to=orm['famille.Prestataire']),
                      keep_default=False)

        # Deleting field 'PrestataireRatings.user'
        db.delete_column(u'famille_prestataireratings', 'user_id')
