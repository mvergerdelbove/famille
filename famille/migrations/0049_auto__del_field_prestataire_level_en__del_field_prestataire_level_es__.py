...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Prestataire.other_language'
        db.delete_column(u'famille_prestataire', 'other_language')

        # Adding field 'Prestataire.language'
        db.add_column(u'famille_prestataire', 'language',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Prestataire.other_language'
        db.add_column(u'famille_prestataire', 'other_language',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Prestataire.language'
        db.delete_column(u'famille_prestataire', 'language')
    ...
    models = {
        ...
        'famille.prestataire': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ipn': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['ipn.PayPalIPN']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'language': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'menage': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
