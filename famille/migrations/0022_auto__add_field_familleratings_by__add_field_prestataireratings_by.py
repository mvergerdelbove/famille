...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FamilleRatings.by'
        db.add_column(u'famille_familleratings', 'by',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'PrestataireRatings.by'
        db.add_column(u'famille_prestataireratings', 'by',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FamilleRatings.by'
        db.delete_column(u'famille_familleratings', 'by')

        # Deleting field 'PrestataireRatings.by'
        db.delete_column(u'famille_prestataireratings', 'by')
