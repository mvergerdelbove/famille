...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Prestataire.tarif'
        db.alter_column(u'famille_prestataire', 'tarif', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Famille.tarif'
        db.alter_column(u'famille_famille', 'tarif', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'Prestataire.tarif'
        db.alter_column(u'famille_prestataire', 'tarif', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Famille.tarif'
        db.alter_column(u'famille_famille', 'tarif', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
