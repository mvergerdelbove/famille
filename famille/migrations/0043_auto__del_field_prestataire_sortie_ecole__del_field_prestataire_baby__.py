...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Prestataire.studies'
        db.add_column(u'famille_prestataire', 'studies',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Prestataire.experience_type'
        db.add_column(u'famille_prestataire', 'experience_type',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Prestataire.experience_year'
        db.add_column(u'famille_prestataire', 'experience_year',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Prestataire.cuisine'
        db.add_column(u'famille_prestataire', 'cuisine',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Prestataire.animaux'
        db.add_column(u'famille_prestataire', 'animaux',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Prestataire.enfant_malade'
        db.add_column(u'famille_prestataire', 'enfant_malade',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Prestataire.nationality'
        db.add_column(u'famille_prestataire', 'nationality',
        ...
        # Adding field 'Famille.studies'
        db.add_column(u'famille_famille', 'studies',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Famille.experience_type'
        db.add_column(u'famille_famille', 'experience_type',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Famille.experience_year'
        db.add_column(u'famille_famille', 'experience_year',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Famille.cuisine'
        db.add_column(u'famille_famille', 'cuisine',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Famille.animaux'
        db.add_column(u'famille_famille', 'animaux',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Famille.enfant_malade'
        db.add_column(u'famille_famille', 'enfant_malade',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Prestataire.studies'
        db.delete_column(u'famille_prestataire', 'studies')

        # Deleting field 'Prestataire.experience_type'
        db.delete_column(u'famille_prestataire', 'experience_type')

        # Deleting field 'Prestataire.experience_year'
        db.delete_column(u'famille_prestataire', 'experience_year')

        # Deleting field 'Prestataire.cuisine'
        db.delete_column(u'famille_prestataire', 'cuisine')

        # Deleting field 'Prestataire.animaux'
        db.delete_column(u'famille_prestataire', 'animaux')

        # Deleting field 'Prestataire.enfant_malade'
        db.delete_column(u'famille_prestataire', 'enfant_malade')

        # Deleting field 'Prestataire.nationality'
        db.delete_column(u'famille_prestataire', 'nationality')
        ...
        # Deleting field 'Famille.studies'
        db.delete_column(u'famille_famille', 'studies')

        # Deleting field 'Famille.experience_type'
        db.delete_column(u'famille_famille', 'experience_type')

        # Deleting field 'Famille.experience_year'
        db.delete_column(u'famille_famille', 'experience_year')

        # Deleting field 'Famille.cuisine'
        db.delete_column(u'famille_famille', 'cuisine')

        # Deleting field 'Famille.animaux'
        db.delete_column(u'famille_famille', 'animaux')

        # Deleting field 'Famille.enfant_malade'
        db.delete_column(u'famille_famille', 'enfant_malade')
