...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Prestataire.visibility_family'
        db.add_column(u'famille_prestataire', 'visibility_family',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Prestataire.visibility_prestataire'
        db.add_column(u'famille_prestataire', 'visibility_prestataire',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Prestataire.visibility_global'
        db.add_column(u'famille_prestataire', 'visibility_global',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Prestataire.visibility_family'
        db.delete_column(u'famille_prestataire', 'visibility_family')

        # Deleting field 'Prestataire.visibility_prestataire'
        db.delete_column(u'famille_prestataire', 'visibility_prestataire')

        # Deleting field 'Prestataire.visibility_global'
        db.delete_column(u'famille_prestataire', 'visibility_global')
