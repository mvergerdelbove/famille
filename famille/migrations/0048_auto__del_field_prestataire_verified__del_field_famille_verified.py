...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Prestataire.verified'
        db.delete_column(u'famille_prestataire', 'verified')

        # Deleting field 'Famille.verified'
        db.delete_column(u'famille_famille', 'verified')


    def backwards(self, orm):
        # Adding field 'Prestataire.verified'
        db.add_column(u'famille_prestataire', 'verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Famille.verified'
        db.add_column(u'famille_famille', 'verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
