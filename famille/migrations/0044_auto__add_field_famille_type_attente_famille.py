...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Famille.type_attente_famille'
        db.add_column(u'famille_famille', 'type_attente_famille',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Famille.type_attente_famille'
        db.delete_column(u'famille_famille', 'type_attente_famille')
