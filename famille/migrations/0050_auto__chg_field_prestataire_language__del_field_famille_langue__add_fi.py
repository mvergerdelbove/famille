...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Prestataire.language'
        db.alter_column(u'famille_prestataire', 'language', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=100, null=True))
        # Deleting field 'Famille.langue'
        db.delete_column(u'famille_famille', 'langue')

        # Adding field 'Famille.language'
        db.add_column(u'famille_famille', 'language',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Prestataire.language'
        db.alter_column(u'famille_prestataire', 'language', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=10, null=True))
        # Adding field 'Famille.langue'
        db.add_column(u'famille_famille', 'langue',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)

        # Deleting field 'Famille.language'
        db.delete_column(u'famille_famille', 'language')
